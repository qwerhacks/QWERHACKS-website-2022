   ...
   return (
      <div class="nav">
         <div class="nav-buttons">
            ...
            <NavLink className="text-link" to="/collaborators"><button type="button" class="nav-button">collaborators</button></NavLink>
            <NavLink className="text-link" to="/resources"><button type="button" class="nav-button">resources</button></NavLink>
            <NavLink className="text-link" to="/about"><button type="button" class="nav-button">about</button></NavLink>
         </div>
